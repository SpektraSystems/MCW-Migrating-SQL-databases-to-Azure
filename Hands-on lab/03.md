...
13. Once logged into Visual Studio, right-click the `WideWorldImportersWeb` project in the Solution Explorer, and then select **Publish**.
    ...
    ![In the Solution Explorer, the context menu for the WideWorldImportersWeb project is displayed, and Publish is highlighted.](media/visual-studio-project-publish.png "Visual Studio")
...
5. On the Configuration blade, locate the **Connection strings** section, and then select the Pencil (Edit) icon to the right of the `WideWorldImportersContext` connection string.
    ...
    ![In the Connection string section, the pencil icon is highlighted to the right of the WideWorldImportersContext connection string.](media/connectapp.png "Connection Strings")
