...
1. Go to your Lab Environment details page and click on the **Go TO JUMPBOX-SUFFIX** button to launch the VM.
  ...
  ![SQL Server is entered into the Windows Start menu search box, and Microsoft SQL Server Management Studio 17 is highlighted in the search results.](media/jumpbox4.png "Windows start menu search")
