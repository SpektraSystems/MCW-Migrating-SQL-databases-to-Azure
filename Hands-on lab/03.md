...
2. In the list of resources for your resource group, select the JumpBox-SUFFIX VM.
    ...
    ![The list of resources in the hands-on-lab-SUFFIX resource group are displayed, and JumpBox is highlighted.](./media/jump.png "JumpBox in resource group list")
