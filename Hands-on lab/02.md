...
3. On the New migration project blade, enter the following:
    ...
    ![The New migration project blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-3.png "New migration project")   ![The New migration project blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-3-Continued.png "New migration project")
...
5. On the Migration Wizard **Select source** blade, enter the following:
    ...
    ![The Migration Wizard Select source blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-5.png "Migration Wizard Select source")
...
7. On the Migration Wizard **Select target** blade, enter the following:
    ...
    ![The Migration Wizard Select target blade is displayed, with the values specified above entered into the appropriate fields.](media/h2.png "Migration Wizard Select target")

8. Select **databases**.

9. On the Migration Wizard **Select databases** blade, select `TailspinToys`.

    ![The Migration Wizard Select databases blade is displayed, with the TailspinToys database selected.](media/Exericse-2-Task-5-Step-9.png "Migration Wizard Select databases")

10. Select **Configure migration settings**.
...
11. On the Migration Wizard **Configure migration settings** blade, enter the following configuration:
    ...
    ![The Migration Wizard Configure migration settings blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-11.png "Migration Wizard Configure migration settings")
  ...
  * Click on Advance Setting.
    ...
    ![The Migration Wizard Configure migration settings blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-11-Continued.png "Migration Wizard Configure migration settings")
...
13. On the Migration Wizard **Summary** blade, enter the following:
    ...
    ![The Migration Wizard summary blade is displayed, Sql2008ToSqlDatabase is entered into the name field, and Validate my database(s) is selected in the Choose validation option blade, with all three validation options selected.](media/Exericse-2-Task-5-Step-13.png "Migration Wizard Summary")
...
1. Within the output of the above command, locate and copy the value of the `fullyQualifiedDomainName` property. Paste the value into a text editor, such as Notepad.exe, for reference below.
...
1. In the Connect to Server dialog, enter the following:
    ...
    - **Server name**: Enter the fully qualified domain name of your SQL managed instance, which you copied from the portal in the previous steps.
...
1. The SQL MI connection appears below the Sql2008-SUFFIX connection. Expand Databases the SQL MI connection and select the `TailspinToys-SUFFIX` database.
