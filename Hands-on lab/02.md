...
1. Now go to Hands-on-lab-SUFFIX Resource group and select sql2008-SUFFIX VM.

    ![The Azure Cloud Shell icon is highlighted in the Azure portal's top menu.](media/p1.png "Azure Cloud Shell")
    
1. Copy the public IP of sql2008-SUFFIX VM and save it in a notepad for later use.

    ![The Azure Cloud Shell icon is highlighted in the Azure portal's top menu.](media/p2.png "Azure Cloud Shell")
...
11. On the Migration Wizard **Configure migration settings** blade, enter the following configuration:
  ...
  * Click on Advance Setting.
    ...
    ![The Migration Wizard Configure migration settings blade is displayed, with the values specified above entered into the appropriate fields.](media/dm.png "Migration Wizard Configure migration settings")
...
1. Now go to SQLMI-Shared-RG Resource group and select sqlmi--cus SQL Managed instance resource.

    ![The Azure Cloud Shell icon is highlighted in the Azure portal's top menu.](media/p4.png "Azure Cloud Shell")
    
1. Copy the Host for sql managed instance and  Paste the value into a text editor, such as Notepad.exe.

   ![The Azure Cloud Shell icon is highlighted in the Azure portal's top menu.](media/p3.png "Azure Cloud Shell")
   
1.  locate and copy the value of the `fullyQualifiedDomainName` property. Paste the value into a text editor, such as Notepad.exe, for reference below.
