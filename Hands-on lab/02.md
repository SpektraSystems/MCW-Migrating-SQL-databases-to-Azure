...
3. On the New migration project blade, enter the following:
    ...
    ![The New migration project blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-3.png "New migration project")
    
    
    ![The New migration project blade is displayed, with the values specified above entered into the appropriate fields.](media/Exericse-2-Task-5-Step-3-Continued.png "New migration project")
...
11. On the Migration Wizard **Configure migration settings** blade, enter the following configuration:
  ...
  * Click on Advance Setting.
    ...
    ![The Migration Wizard Configure migration settings blade is displayed, with the values specified above entered into the appropriate fields.](Exericse-2-Task-5-Step-11-Continued.png "Migration Wizard Configure migration settings")
