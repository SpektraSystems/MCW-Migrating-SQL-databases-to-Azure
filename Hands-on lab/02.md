...
9. On the Migration Wizard, select **Source databases** blade and select `WideWorldImporters`. Then click on **Next: Configure migration settings**.
...
11. On the Migration Wizard **Configure migration settings** blade, enter the following configuration:
  ...
  * Click on **Advance Settings**
    ...
    ![The Migration Wizard Configure migration settings blade is displayed, with the values specified above entered into the appropriate fields.](media/dm13.png "Migration Wizard Configure migration settings")
