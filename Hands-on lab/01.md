...
1. From your Lab details page click on the **Go to SQLServer-SUFFIX** button to launch the VM.
  ![SQL Server is entered into the Windows Start menu search box, and Microsoft SQL Server Management Studio 17 is highlighted in the search results.](media/goto.png "Windows start menu search")
  
2. Once VM launched,In a browser Navigate to the **Azure portal** `https://portal.azure.com` and login to Azure portal with below credentials. 

    * Azure Usename/Email: <inject key="AzureAdUserEmail"></inject>
    * Azure Password: <inject key="AzureAdUserPassword"></inject>

   
3. Select the hands-on-lab-SUFFIX resource group from the Resource group list.
...
9. In the VM Open **Microsoft SQL Server Management Studio 17** (SSMS) by entering "sql server" into the search bar in the Windows Start menu and selecting **Microsoft SQL Server Management Studio 17** from the search results.
