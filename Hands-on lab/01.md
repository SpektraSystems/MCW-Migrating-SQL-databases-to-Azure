...
1. Navigate to the **Azure portal** `https://portal.azure.com` and login and login with below credentials. 

    * Azure Usename/Email: <inject key="AzureAdUserEmail"></inject>
    * Azure Password: <inject key="AzureAdUserPassword"></inject>

   
2. Select the hands-on-lab-SUFFIX resource group from the Resource group list.

    ![Resource groups is selected in the Azure navigation pane, and the "hands-on-lab-SUFFIX" resource group is highlighted.](./media/rg.png "Resource groups list")

3. In the list of resources for your resource group, select the Sql2008-SUFFIX VM.

    ![The SqlServer2008 VM is highlighted in the list of resources.](media/sql2008.png "Resource list")

4. On the sql2008-SUFFIX VM blade in the Azure portal, select **Overview** from the left-hand menu, and then select **Connect** on the top menu, as you've done previously.

    ![The SqlServer2008 VM blade is displayed, with the Connect button highlighted in the top menu.](./media/connectsql2008.png "Connect to SqlServer2008 VM")
...
6. On the **Sources** screen, enter the following into the **Connect to a server** dialog that appears on the right-hand side:
    ...
    ![In the Connect to a server dialog, the values specified above are entered into the appropriate fields.](media/dma1.png "Connect to a server")
