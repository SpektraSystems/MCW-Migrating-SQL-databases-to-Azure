...
1. Navigate to the **hands-on-lab-vnet-gateway** Virtual network gateway in the Azure portal by selecting it from the list of resources in the SQLMI-Shared-RG resource group.
...
4. Select the **SQLMI-VNET-Shared** in the Virtual Network dialog.
